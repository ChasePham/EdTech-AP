  ...
  return (
    ...
    <div className="div">
      ...
      <div className="overlap-2">
        ...
        <img className="my-account" alt="My account" src={myAccount} />
        <img className="rectangle-stroke-6" alt="Rectangle stroke" src={rectangle2Box} />
        <div className="group">
        ...
        <div className="text-wrapper-7">octomize.</div>
        <p className="p">complete your daily tasks with octo!</p>
        <img className="bubbles" alt="Bubbles" src={bubbles} />
      </div>
